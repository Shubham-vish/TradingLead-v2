...
from SharedCode.Models.Order.user_stoplosses import StoplossCheckAt, StoplossType
...
def execute_stoploss_for_user(user_stoplosses:UserStoplosses,  check_at:StoplossCheckAt, tel_props,):
    ...
    stoplosses = user_stoplosses.get_stoplosses(StoplossType.line , check_at)
    ...
    telemetry.info(f"Stoplosses found for {check_at} for: user_stoplosses: {user_stoplosses}", tel_props)
